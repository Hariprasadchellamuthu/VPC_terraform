            ...
            steps {
                    ...
                    sh """
                        ...
                        terraform plan -out tfplan \
                            ...
                            -var="public_subnet_cidrs=${params.publicSubnetCidrBlock.split(',').collect { it.trim() }.join(', ')}" \
                            -var="private_subnet_cidrs=${params.privateSubnetCidrBlock.split(',').collect { it.trim() }.join(', ')}"
